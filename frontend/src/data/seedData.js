...
function generatePastAttendance() {
  const records = [];
  ...
  records.push({
    ...
    extraHours: 0,
    status: 'Present',
    notes: 'Working from Bangalore Tech Hub',
  });
  ...
  records.push({
    ...
    extraHours: 1.25,
    status: 'Present',
    notes: 'Completed payroll sprint review',
  });
  ...
  records.push({
    ...
    extraHours: 0,
    status: 'Present',
    notes: 'Executive alignment session',
  });
  ...
  for (let i = 1; i <= 10; i++) {
    ...
    employees.forEach((empId, idx) => {
      if (empId === 'emp-3' && i === 1) return;

      const randomMinutes = Math.floor(Math.random() * 20);
      const randomWorkHours = Number((8.2 + (idx % 3) * 0.4 + randomMinutes / 60).toFixed(2));
      const extra = Math.max(0, Number((randomWorkHours - 8).toFixed(2)));

      records.push({
        id: `att-past-${empId}-${dateStr}`,
        employeeId: empId,
        date: dateStr,
...
export const INITIAL_ATTENDANCE = generatePastAttendance();
...
export const INITIAL_LEAVES = [
  {
    ...
    employeeAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=faces',
    department: 'Product',
  ...
  },
  {
    ...
    employeeAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=300&h=300&fit=crop&crop=faces',
    department: 'Engineering',
  ...
  },
  {
    ...
    employeeAvatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=300&h=300&fit=crop&crop=faces',
    department: 'Human Resources',
    leaveType: 'Paid Time Off',
  ...
  },
  {
    ...
    employeeAvatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&h=300&fit=crop&crop=faces',
    department: 'Design',
